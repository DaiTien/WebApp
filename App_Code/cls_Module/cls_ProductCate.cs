...
public class cls_ProductCate
{
    ...
    //    else
    //    {
    //        string getTitleCate = (from c in db.tbProductCates select c.productcate_title).ToString();
    //        insert.link_seo = cls_ToAscii.ToAscii(getTitleCate.ToLower()) + "/" +  cls_ToAscii.ToAscii(productcate_title.ToLower()) + "-" + insert.productcate_id;
    //    }
    //    try
    //    {
    //        db.SubmitChanges();
    ...
    //    else
    //    {
    //        string getTitleCate = (from c in db.tbProductCates where c.productcate_id == parent select c).SingleOrDefault().productcate_title;
    //        update.link_seo = cls_ToAscii.ToAscii(getTitleCate.ToLower()) + "/" + cls_ToAscii.ToAscii(productcate_title.ToLower()) + "-" + update.productcate_id;
    //    }
    //    try
    //    {
    //        db.SubmitChanges();
