<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="admin_AdminViewBooking.aspx.cs" Inherits="admin_page_module_function_admin_AdminViewBooking" %>
                                    ...
                                    <div class="modal-content modal-content-demo">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mg-t-10">Gía phòng / Ngày : <%#Eval("order_priceRoom","{0:0,0}") %> ₫</div>
                                                <div class="col-md-6 mg-t-10">Loại giá : <%#Eval("order_loaiGia") %></div>
                                                <div class="col-md-6 mg-t-10">Giá trị hiển thị : <%#Eval("order_priceShow","{0:0,0}") %> ₫</div>
