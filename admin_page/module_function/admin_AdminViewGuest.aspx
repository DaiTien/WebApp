<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_MasterPage.master" AutoEventWireup="true" CodeFile="admin_AdminViewGuest.aspx.cs" Inherits="admin_page_module_function_admin_AdminViewGuest" %>
        ...
        <div class="container-fluid">
            ...
            <div class="az-content-body d-flex flex-column">
                <div class="az-content-breadcrumb">
                    <span>Admin</span>
                    <span>Admin View Guest</span>

                </div>
                <h2 class="az-content-title">Admin View Guest</h2>
                ...
                <div>
                    <div class="flex-wrap d-flex mg-b-20">
                        ...
                        <div class="mg-t-15 mg-r-15">
                            <p></p>
                            <a href="#" id="btn_Loc" class="btn btn-primary btn-block " runat="server" onserverclick="btn_Loc_ServerClick" >Lọc</a>

                        </div>
                        <div class="mg-t-15">
                            <p></p>
                            <button class="btn btn-primary btn-block" id="btnNhapExcel" runat="server" onserverclick="btnXuatExcel_ServerClick">Xuất Excel</button>
                    ...
                    <table id="example2" class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-5p">Checkin</th>
                                <th class="wd-5p">Checkout</th>
                            ...
                            <asp:Repeater ID="rpViewGuest" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary btn-block" href="#" data-toggle="modal" data-target="#modaldemo<%#Eval("order_id") %>" onclick="getID(<%#Eval("order_idGuest") %>)">Chi Tiết</a></td>
